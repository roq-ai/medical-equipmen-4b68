...
function DashboardPage() {
  ...
  const equipmentStat = useSWR<PaginatedInterface<EquipmentInterface>>(
    () => `/equipment`,
    () => getEquipment({ limit: 1, offset: 0 }),
  );

  const supplierStat = useSWR<PaginatedInterface<SupplierInterface>>(
    () => `/suppliers`,
    () => getSuppliers({ limit: 1, offset: 0 }),
  );
