...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['inventory-manager', 'system-administrator', 'supply-chain-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Equipment', path: '/equipment', entity: 'equipment', service: AccessServiceEnum.PROJECT, icon: FiBox },
